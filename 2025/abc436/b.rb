def main
    ...
    (n ** 2 - 1).times do |i|
        count += 1
        if map[(zahyou[0] - 1) % n][(zahyou[1] + 1) % n] == 0
            map[(zahyou[0] - 1) % n][(zahyou[1] + 1) % n] = count
            zahyou = [(zahyou[0] - 1) % n, (zahyou[1] + 1) % n]
        else
            map[(zahyou[0] + 1) % n][zahyou[1]] = count
            zahyou = [(zahyou[0] + 1) % n, zahyou[1]]
        end
    end
    map.each do |i|
        puts i.join(" ")

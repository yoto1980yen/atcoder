def main
    ...
    m.times do |i|
        r, c = intary
        next if visited.include?(r * 1000000 + c) || visited.include?((r + 1) * 1000000 + c) || visited.include?(r * 1000000 + c + 1) || visited.include?((r + 1) * 1000000 + c + 1)
        visited << r * 1000000 + c
        visited << (r + 1) * 1000000 + c
        visited << r * 1000000 + c + 1
        visited << (r + 1) * 1000000 + c + 1
        ans += 1
    end
    puts ans
end

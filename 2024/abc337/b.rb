def main
    ...
    pp a
    if a.size == 3
        unless a[0].first == "A" && a[1].first == "B" && a[2].first == "C"
            judge = false
        end
    elsif a.size == 2
        if a[0].first == "A" && a[1].first == "B"
            judge = true
        elsif a[0].first == "B" && a[1].first == "C"
            judge = true
        elsif a[0].first == "A" && a[1].first == "C"
            judge = true
        else
            judge = false
        end
    elsif a.size == 1
        unless a[0].first == "A" || a[0].first == "B" || a[0].first == "C"
            judge = false
        end
    else
        judge = false
